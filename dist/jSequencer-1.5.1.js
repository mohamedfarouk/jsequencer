    ...
    function ExecutionContext(funcTable, resumeOnError, stateChangeCallback) {
        ...
        function runSequence(resumeIndex, lastResult) {
            ...
            try {
                ...
                setState.call(this, STAT_ERROR, currentStepIndex, ex, lastResult, setState);
            }
            ...
            if (state === STAT_BREAK) {
                ...
                results[currentStepIndex] = returnVal;
                setState.call(this, STAT_STEP_EXECUTED, currentStepIndex, returnVal);
        ...
        function stateChanged(state, stepIndex) {
            ...
            if (state === STAT_BREAK) {
                ...
                if (typeof stepCallback === "function") {
                    stepCallback.call(stepContext, this, arguments[2]);
                }
            }
            else if (state === STAT_PAUSED) {
                ...
                if (args.resume) {
                    ...
                    if (typeof arguments[4] === 'function') {
                        var setState = arguments[4];
                        setState.call(this, STAT_FAILED, stepIndex, arguments[2], arguments[3]);
                    }
                }
            }
